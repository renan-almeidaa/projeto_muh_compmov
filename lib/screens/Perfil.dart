                      ...
                      child: Stack(
                        children: [
                          Center(
                              child: CircleAvatar(
                            radius: 50,
                            backgroundImage: (model.background_image == null
                                ? AssetImage("assets/person-icon.png")
                                : NetworkImage(model
                                    .background_image)), //coloca a imagem da pessoa, coloca background imagem
                          )),
                          Center(
                              child: Padding(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(left: 15),
                      child: Text(
                        "Gado de qualidade é comigo mesmo!", // nome da pessoa
                        style: TextStyle(
                              ...
                              (index) {
                                return GestureDetector(
                                  onTap: () {
                                    ...
                                    print(
                                        "Descricao: " + model.descricao[index]);
                                    //data
                                    //nome da pessoa
                                    //imagem_perfil
                                    /*
                                    ...
                                    Navigator.of(context).push(
                                        MaterialPageRoute(
                                            builder: (context) => Publications(
                                                model.imagem[index],
                                                model.descricao[index],
                                                model.preco[index],
                                                model.nome_identificacao,
                                                model.datas[index],
                                                model.background_image)));
                                  },
                                  child: Padding(
